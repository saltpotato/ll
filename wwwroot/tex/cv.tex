...
\cvline{\house}{Brunnenstrasse 5, 9470 Buchs SG (CH)}
\cvline{\mobilephonesymbol}{+4915782951831}
\section{Berufserfahrung}
\cventry{Oktober 2019--heute}{Fullstack Entwickler}{ELPRO-BUCHS AG}{Buchs SG}{}{Monitoring Lösungen für Pharma und Healthcare \begin{itemize} 
\item Entwicklung Microservices mit ASP.NET, Postgres und RabbitMq
\item ReactJS bezüglich Zahlungsabwicklung und Lizensierung
\item Pflege AWS Deployment    
 \end{itemize} } 
\cventry{Juli 2018--Juli 2019}{Softwareentwickler .NET}{Beissbarth GmbH}{München}{}{Fahrwerkvermessung, Bremsenprüfung, Prüfstrassen und Scheinwerfereinstellung \begin{itemize} 
...
\item Anbindung Druckluftsensoren neuerer Generation
\item Gelegentlicher vor Ort Einsatz beim Kunden    
 \end{itemize} } 
\cventry{April 2014--Juni 2018}{Softwareentwickler Windows Apps}{Distec GmbH}{Germering}{}{Spezialist für LCD Flachbildschirm-Lösungen \begin{itemize} 
...
\item Ansprechpartner rund um Windows innerhalb der Entwicklunsabteilung    
 \end{itemize} } 
\cventry{Januar 2012--Oktober 2013}{Softwareentwickler .NET}{CreateCtrl AG}{München}{}{Software für TV, VoD und Radio \begin{itemize} 
...
\end{itemize}    
 \end{itemize} } 
\cventry{Juli 2005--Dezember 2011}{Softwareentwickler C++}{ZIP Industrieplanung}{München}{}{Systeme zur Fabrik- und Logistikplanung \begin{itemize} 
...
\item Bereitstellung von Builds und Pflege des Build-Systems    
 \end{itemize} } 
\cventry{November 2003--Juni 2005}{Softwareentwickler .NET}{WSW Software GmbH}{Gauting (München)}{}{Hoch konfigurierbare IT-Logistiklösungen auf Basis von SAP und .Net \begin{itemize} 
...
\cvline{C++}{C++ 11, Managed C++, STL, Qt 5, Windows 10-Sdk}
\cvline{Datenbanken}{Postgres, Oracle 9/10i, NHibernate}
\cvline{SCM}{Tortoise Git, Svn, Gitlab}
\section{Hobbies}
